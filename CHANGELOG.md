...
- **Persistence**: Inbox and webhook persistence with automatic restoration on startup

[0.9.3]: https://github.com/vaultsandbox/gateway/releases/tag/v0.9.3

## [0.9.2] - 2026-01-27

### Changed

- **Docker**: Updated Node.js from 24 to 24.13.0 in Dockerfile and Dockerfile.harden

[0.9.2]: https://github.com/vaultsandbox/gateway/releases/tag/v0.9.2

## [0.9.1] - 2026-01-22

### Added

- **Frontend(bug fix)**: Simplify chaos config main toggle to sync only on item click.

[0.9.1]: https://github.com/vaultsandbox/gateway/releases/tag/v0.9.1
